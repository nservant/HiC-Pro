/* Generated by Cython 0.20.1post0 (Debian 0.20.1+git90-g0e6e38e-1ubuntu2) on Wed Jun 29 17:57:03 2016 */
...
static PyObject *__pyx_pf_4iced_8_filter___filter_csr(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_X, PyArrayObject *__pyx_v_bias) {
  ...
  __pyx_pybuffernd_bias.rcbuffer = &__pyx_pybuffer_bias;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_bias.rcbuffer->pybuffer, (PyObject*)__pyx_v_bias, &__Pyx_TypeInfo_nn___pyx_t_4iced_8_filter__BOOL, PyBUF_FORMAT| PyBUF_STRIDES, 1, 1, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
 ...
 */
    ...
    __pyx_t_11 = ((*__Pyx_BufPtrStrided1d(__pyx_t_4iced_8_filter__BOOL *, __pyx_pybuffernd_bias.rcbuffer->pybuffer.buf, __pyx_t_9, __pyx_pybuffernd_bias.diminfo[0].strides)) != 0);
    if (!__pyx_t_11) {
